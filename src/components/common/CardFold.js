          ...
          <Card className="rounded my-4">
            ...
            <Card.Body className="px-2 pt-3">
              ...
              <Card.Text>
                ...
                all Devonshire difficulty gay assistance joy. Unaffected at ye
                of compliment alteration to. Satisfied conveying a dependent
                ...
                objection do Mr prevailed. Mr feeling does chiefly cordial in
                do.{" "}
              </Card.Text>

              <ul className="nav nav-divider align-items-center text-uppercase small">
                <li className="nav-item">
                  <Link to="/acercadenosotros" className="nav-link text-reset btn-link">
                    Abel Córdoba González
                  </Link>
                </li>
                <li className="nav-item"> | Marzo 07, 2021</li>
              </ul>
            </Card.Body>
          </Card>
    </>
